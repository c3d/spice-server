                           ...
                           gboolean        discard_all)
{
    ...
    agent_msg_filter_config(filter, copy_paste, file_xfer, use_client_monitors_config);
    filter->discard_all = discard_all;
}

AgentMsgFilterResult
agent_msg_filter_process_data(AgentMsgFilter *filter, const uint8_t *data, uint32_t len)
{
